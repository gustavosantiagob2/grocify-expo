...
export default function Page() {
  ...
  return (
    <View className="bg-white dark:bg-black p-4" style={styles.container}>
      ...
      <View className="bg-white dark:bg-black p-4" style={styles.linkContainer}>
...
// # DEPOIS QUANDO ESTIVER COM O CELULAR RODAR O NPX RUN:ANDROID E APAGAR O CÓDIGO DE CIMA PARA RODAR COM ESSE
