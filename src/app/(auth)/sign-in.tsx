...
export default function SignInScreen() {
  ...
  return (
    ...
    >
      {/* decorative elements */}
      <View className="absolute -left-16 top-12 h-56 w-56 rounded-full bg-primary/80 dark:background/40" />
      <View className="absolute right-[-74] top-40 h-72 w-72 rounded-full bg-primary/70 dark:background/45 " />
      ...
      <View className="mt-8 flex-1 rounded-t-[36px] bg-card px-6 pb-8 pt-6 ">
        ...
        <View className="mt-6">
          ...
          >
            ...
            <Text className="ml-3 flex-1 text-lg font-semibold text-card-foreground">
              {isGoogleClicked ? "Connecting Apple..." : "Continue with Apple"}
            </Text>
            <FontAwesome name="angle-right" size={18} color="#5f6e66" />
          </Pressable>
        </View>
